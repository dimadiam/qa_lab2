...
from exceptions import CatIsNotFedError, MissTheBusError, SomeExtraordinaryError
...
@pytest.mark.parametrize(
	...
	[
		((CatIsNotFedError, MissTheBusError),(True,False), 1, 1),
		((CatIsNotFedError, CatIsNotFedError),(True,True), 2, 0),
		((MissTheBusError, MissTheBusError),(False,False), 0, 2),
	],
)
...
@pytest.mark.parametrize(
	...
	[
		((CatIsNotFedError, MissTheBusError), 1, 1),
		((CatIsNotFedError, CatIsNotFedError), 2, 0),
		((MissTheBusError, MissTheBusError), 0, 2),
	],
)
